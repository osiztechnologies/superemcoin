...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Supremecoin supremecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  supremecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Supremecoin transaction") + "\n" +
              "  supremecoin-tx [options] -create [commands]   " + _("Create hex-encoded Supremecoin transaction") + "\n" +
              "\n";
