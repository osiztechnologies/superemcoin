// Copyright (c) 2018 The Supremecoin Community
...
./supremecoind -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client version 1.0.10 has degraded networking behavior. Please update to the most recent version of Supremecoin (1.2.0 or later).";
